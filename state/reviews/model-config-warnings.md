...
Phase: `generate_proposal`. Configuration source: `.open-study-path/models.yml`.
...
- content_author is configured for 'haiku', below its recommended tier ('sonnet') for a structural decision. Generated or reviewed content is likely to be less thorough than the default.
- content_reviewer is configured for 'haiku', below its recommended tier ('sonnet') for a structural decision. Generated or reviewed content is likely to be less thorough than the default.
- evaluate is configured for 'haiku', below its recommended tier ('sonnet') for a structural decision. Generated or reviewed content is likely to be less thorough than the default.
